            ...
            >
                <b-skeleton-wrapper :loading="!preloadImage">
                    ...
                    <img
                        width="32px"
                        :src="
                            `https://skin.vimeworld.ru/head/${person.username}.png?_=16057785`
                        "
                        alt=""
                    />
                    <div
                        ...
                        :style="{
                            backgroundImage: `url(https://skin.vimeworld.ru/raw/skin/${person.username}.png?_=16057785)`
                        }"
                    ></div>
                </b-skeleton-wrapper>
            </div>
...
export default {
    ...
    mounted() {
        ...
        preload(
            `https://skin.vimeworld.ru/head/${this.person.username}.png?_=16057785`
        )
        preload(
            `https://skin.vimeworld.ru/raw/skin/${this.person.username}.png?_=16057785`,
